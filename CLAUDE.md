...
- **North Star**: 에이전시당 월 $50 매출액 (12개월)
- **즉시 과제**: 3개 베타 고객 NPS 50+ 확보, 25개 템플릿 큐레이션
...
| 작업 | 공통 스킬 | 비고 |
|------|----------|------|
| 랜딩·웹 디자인 | `/vibers-design` | DARK_ORANGE(행사·에이전시) / SOFT_LIGHT(SaaS) |
| 서버·Docker 점검 | `/vibers-admin` | NCP 포트 4040 |
