...
| 영역 | 주요 파일 | 담당 |
|------|---------|------|
| 템플릿 마켓 | design_templates_controller, design_template.rb | [AG] |
| 견적 시스템 | pages_controller#create_quote, quote.rb, quote_mailer.rb | [CC] |
| 주문/결제 | orders_controller, order.rb, cart*.rb | [CC] |
| 에이전시 관리 | agency.rb, admin/agencies_controller | [AG] |
| Admin 대시보드 | admin/ 전체 | [TCC] |
| 마이페이지 | mypage_controller | [TCC] |
| 디자인 시스템 | application.tailwind.css, design_system_controller | [AG] |
| 인프라/배포 | Dockerfile, docker-compose.yml, .github/ | [CW] |

## 메시지 로그

### 2026-03-24
- [CW] Fly.io → NCP Docker 이전 완료
- [CW] 프로젝트 공통 지침 파일 세팅 (CLAUDE.md 보강, OKR.md, DESIGN_GUIDE.md, COLLABORATION.md 생성)
